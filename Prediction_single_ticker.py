...
directory = os.listdir('{}/Data/Prediction data/test_single prediction/'.format(DATEIPFAD))
...
try:
    ...
    if length>50:
      ...
      with open('{}/Data/Prediction data/test_single prediction/{}.csv'.format(DATEIPFAD, COLUMN), mode='w') as file:
